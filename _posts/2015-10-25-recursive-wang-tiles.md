...
The Recursive Wang Tiles method for generating blue noise ([Kopf 2006](http://prideout.net/rwt/Kopf2006.pdf)) can quickly generate a progressive sequence by consuming a small set of pre-generated tiles.  On the downside, these tiles are complex to construct.
...
* [trillium.png](http://prideout.net/assets/trillium.png) (890 KB)
* [terrainpts.png](http://prideout.net/assets/terrainpts.png) (50 KB)
...
* [Recursive Wang Tiles for Real-Time Blue Noise](http://prideout.net/rwt/Kopf2006.pdf) by Johannes Kopf et al.
