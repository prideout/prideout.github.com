...
So far I'm loving Go, especially when compared to vanilla C.  I have a couple small gripes.  For example, enumerations aren't totally type-safe since they can be freely exchanged with `int`.  They do, however, have a cute feature called `iota`.
